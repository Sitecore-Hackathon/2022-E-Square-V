...
//using Mvp.Foundation.Caching;
using Mvp.Foundation.CustomMiddleware.Rendering.Extension;
using Mvp.Foundation.GraphQLEdgeConnector.Rendering;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSitecoreLayoutService()
              ...
              .AddCustomLayoutRequestHandler("default", Configuration.LayoutServiceUri) // The CustomLayoutRequestHandler
              //.AddHttpHandler("default", Configuration.LayoutServiceUri) // This is the default one which has to be commented out 
              .AsDefaultHandler();
            ...
            services.AddGraphQLRequestMiddlewareFoundation();
            services.AddSession();
        }
